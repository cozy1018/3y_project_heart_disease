...
# Train expert models (SVM, Logistic Regression, Naive Bayes) using the resampled data
...
model.fit(X_train_experts, y_train_resampled, epochs=400, batch_size=32, verbose=0)
